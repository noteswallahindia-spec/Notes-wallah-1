...
const SEED_TESTS = [
  ...
  // Class 10 Full Syllabus Science Mock
  {
    ...
    description: "Complete 5-question mock test spanning Physics, Chemistry, and Biology curated directly from board blueprints.",
    duration_mins: 20,
  ...
  // Class 10 Full Syllabus All Subjects Mock
  {
    id: "test_c10_full_mock",
    class_id: "class_10",
    subject_id: "all",
    subject_name: "All Subjects",
    chapter_id: "",
    test_type: "full_syllabus",
    title: "Class 10 All Subjects: Full Board Mock Examination",
    description: "Grand mock exam simulating the board examination pattern across Science, Mathematics, and Social Science.",
    duration_mins: 25,
    difficulty: "Board Target",
    questions: [
      {
        id: "q_c10_all_1",
        question: "Which of the following processes is a chemical reaction?",
        options: [
        ...
        explanation: "Heating copper wire in air at high temperature forms a new chemical compound, black copper oxide (2Cu + O₂ → 2CuO), which is a chemical reaction."
      },
      {
        id: "q_c10_all_2",
        ...
        correct_index: 2,
        concept: "Real Numbers & LCM",
        explanation: "The smallest composite number is 4. The smallest two digit composite number is 10. LCM(4, 10) = 20."
      },
      {
        id: "q_c10_all_3",
        question: "Which soil is also known as 'Regur Soil' and is ideal for growing cotton?",
        options: [
          "Alluvial Soil",
          "Black Soil",
          "Red and Yellow Soil",
        ...
        correct_index: 1,
        concept: "Resources and Development (Soil Types)",
        explanation: "Black soil is typically known as regur soil or black cotton soil. It is rich in soil nutrients such as calcium carbonate, magnesium, potash and lime."
      },
      {
        id: "q_c10_all_4",
        ...
        correct_index: 3,
        concept: "Electricity - Power & Resistance",
        explanation: "Resistance R = V² / P = (220)² / 100 = 484 Ω. When operated at 110 V, P' = V'² / R = (110)² / 484 = 12100 / 484 = 25 W."
      },
      {
        id: "q_c10_all_5",
        question: "The power sharing arrangement in Belgium is regarded as an ideal model because:",
        options: [
          "It gave dominance to the Dutch-speaking majority",
          "It accommodated regional differences and cultural diversities peacefully",
          "It abolished local self governments",
          "It enforced a single state religion"
        ],
        correct_index: 1,
        concept: "Democratic Politics - Power Sharing",
        explanation: "The Belgian model successfully accommodated both Dutch and French speaking communities with equal representation, preventing civil conflict and partition."
      }
    ]
  },
  ...
  // Class 11 Physics Test
  {
    id: "test_c11_phy_ch1",
    class_id: "class_11",
    subject_id: "c11_physics",
    subject_name: "Physics",
    chapter_id: "c11_phy_ch1",
    test_type: "chapter",
    title: "Class 11 Physics: Physical World and Units & Measurement",
    description: "Fundamental dimensional analysis, significant figures, errors in measurement, and SI unit definitions.",
    duration_mins: 15,
    difficulty: "Standard",
    questions: [
      {
        ...
        correct_index: 2,
        concept: "Units and Measurements (SI Base Units)",
        explanation: "Newton is a derived unit (1 N = 1 kg·m·s⁻²). The seven base SI units are meter, kilogram, second, ampere, kelvin, mole, and candela."
      },
      {
        id: "q_c11_phy_2",
        question: "The dimensional formula for Planck's constant (h) is identical to that of:",
        options: [
          "Linear Momentum",
          "Angular Momentum",
          "Work done",
        ...
        correct_index: 1,
        concept: "Dimensional Analysis (Planck's Constant)",
        explanation: "E = h·ν ⇒ [h] = [E] / [ν] = [M L² T⁻²] / [T⁻¹] = [M L² T⁻¹]. Angular momentum L = m·v·r ⇒ [L] = [M][L T⁻¹][L] = [M L² T⁻¹]. Hence [h] = [Angular Momentum]."
      },
      {
        id: "q_c11_phy_3",
        question: "The number of significant figures in 0.002030 is:",
        options: [
          "6",
          "4",
          "3",
        ...
        explanation: "Leading zeroes before the first non-zero digit are not significant. The digits '2', '0', '3', and the trailing '0' after the decimal are significant, giving 4 significant figures."
      }
    ]
  },
  // Class 12 Physics Test
  {
    id: "test_c12_phy_ch1",
    class_id: "class_12",
    subject_id: "c12_physics",
    subject_name: "Physics",
    chapter_id: "c12_phy_ch1",
    test_type: "chapter",
    title: "Class 12 Physics: Electric Charges and Fields",
    description: "Core board examination test on Coulomb's law, electric field lines, electric dipole, and Gauss's law applications.",
    duration_mins: 15,
    difficulty: "Standard",
    questions: [
      {
        id: "q_c12_phy_1",
        question: "SI unit of electric permittivity of free space (ε₀) is:",
        options: [
          "C² N⁻¹ m⁻²",
          "N m² C⁻²",
          "N C⁻¹ m²",
        ...
        correct_index: 0,
        concept: "Coulomb's Law and Permittivity (ε₀)",
        explanation: "From Coulomb's Law F = (1 / 4πε₀) · (q₁q₂ / r²), ε₀ = (q₁q₂) / (4πF r²). Units: C² / (N · m²) = C² N⁻¹ m⁻²."
      },
      {
        id: "q_c12_phy_2",
        question: "An electric dipole of moment p is placed in a uniform electric field E. The torque experienced by it is:",
        options: [
          "p · E",
          "p × E",
          "Zero",
        ...
        explanation: "The torque acting on an electric dipole in a uniform electric field is given by the vector cross product τ = p × E."
      },
      {
        id: "q_c12_phy_3",
        question: "Electric field intensity at a distance r from an infinitely long straight uniformly charged wire of linear charge density λ is proportional to:",
        options: [
          "r",
          "1 / r²",
          "1 / r",
        ...
        correct_index: 2,
        concept: "Gauss's Law Application - Infinite Line Charge",
        explanation: "Using Gauss's Law for an infinite line charge of linear density λ: E = λ / (2πε₀ r). Therefore, E is proportional to 1 / r."
      }
    ]
  }
];
...
class TestEngineService {
  ...
  /**
   * Sync custom tests from Firestore / LocalStorage
   */
  async syncCustomTests(classId) {
    try {
      const customTests = await window.NotesWallahDatabase.getAvailableTests(classId);
      if (Array.isArray(customTests)) {
        customTests.forEach(ct => {
          const idx = this.tests.findIndex(t => t.id === ct.id);
          if (idx >= 0) {
            this.tests[idx] = { ...this.tests[idx], ...ct };
          } else {
            this.tests.push(ct);
          }
        });
      ...
      console.warn("[TestEngine] Sync custom tests skipped:", e);
    }
  }

  /**
   * Subview Navigation Controller
   */
  showSubview(viewId, pushToStack = true) {
    const container = document.getElementById("screen-test");
    if (!container) return;

    const subviews = container.querySelectorAll(".test-subview");
    subviews.forEach(sv => {
      sv.style.display = "none";
    });

    const target = document.getElementById(`test-subview-${viewId}`);
    if (target) {
      target.style.display = "block";
      this.currentView = viewId;
      if (pushToStack) {
        if (this.viewStack[this.viewStack.length - 1] !== viewId) {
  ...
  /**
   * Return to previous subview in test tab without reloading page or navigating away
   */
  goBack(classId = "class_10") {
    if (this.viewStack.length > 1) {
      this.viewStack.pop(); // Pop current
      const prevView = this.viewStack[this.viewStack.length - 1];
      this.showSubview(prevView, false);
      if (prevView === "home") {
        this.renderTestHub(classId);
      }
    } else {
      this.viewStack = ["home"];
      this.showSubview("home", false);
      this.renderTestHub(classId);
    }
  }
  ...
  async renderTestHub(classId) {
    ...
    // Sync any custom admin tests
    await this.syncCustomTests(normClass);

    // Ensure we are on current subview or default to home
    if (!this.currentView || this.currentView === "home") {
      this.showSubview("home", false);
    } else {
      this.showSubview(this.currentView, false);
    }

    // 1. Bind Navigation Mode Selection Cards
    const btnFullSyllabus = document.getElementById("btn-mode-full-syllabus");
    if (btnFullSyllabus) {
      btnFullSyllabus.onclick = () => this.openFullSyllabus(normClass);
    }

    const btnSubjectTests = document.getElementById("btn-mode-subject-tests");
    if (btnSubjectTests) {
      btnSubjectTests.onclick = () => this.openSubjectTests(normClass);
    }

    const btnChapterTests = document.getElementById("btn-mode-chapter-tests");
    if (btnChapterTests) {
      btnChapterTests.onclick = () => this.openSubjectTests(normClass);
    }

    const btnTestHistory = document.getElementById("btn-mode-test-history");
    if (btnTestHistory) {
      btnTestHistory.onclick = () => this.openTestHistory();
    }

    const btnViewAllHistory = document.getElementById("btn-view-all-history");
    if (btnViewAllHistory) {
      btnViewAllHistory.onclick = () => this.openTestHistory();
    }

    // 2. Bind Back Buttons on all Subviews
    const backFull = document.getElementById("btn-back-from-full-syllabus");
    if (backFull) backFull.onclick = () => this.goBack(normClass);

    const backSubj = document.getElementById("btn-back-from-subjects");
    if (backSubj) backSubj.onclick = () => this.goBack(normClass);

    const backChap = document.getElementById("btn-back-from-chapters");
    if (backChap) backChap.onclick = () => this.goBack(normClass);

    const backDetail = document.getElementById("btn-back-from-chapter-detail");
    if (backDetail) backDetail.onclick = () => this.goBack(normClass);

    const backHist = document.getElementById("btn-back-from-history");
    if (backHist) backHist.onclick = () => this.goBack(normClass);

    // 3. Render Recent Tests & Performance
    await this.renderRecentAttempts();

    // 4. Render Subject Filter Chips & Featured Practice Tests
    await this.renderHomeFeaturedTests(normClass);
  }

  /**
   * Render Recent Tests in Test Home
   */
  async renderRecentAttempts() {
    const container = document.getElementById("test-home-recent-attempts-container");
    if (!container) return;
    ...
    const attempts = await window.NotesWallahDatabase.getUserTestAttempts(userId);

    if (!attempts || attempts.length === 0) {
      container.innerHTML = `
        <div class="empty-state" style="padding: var(--spacing-3); background: var(--color-bg-subtle); border-radius: var(--radius-md); border: 1px dashed var(--color-border-subtle); text-align: center;">
          <h4 class="empty-state-title" style="font-size: var(--font-size-xs); margin-bottom: 2px;">No tests completed yet.</h4>
          <p class="empty-state-subtitle" style="font-size: 0.688rem; margin: 0; color: var(--color-text-secondary);">
            Complete any full mock or chapter test to track your board preparation accuracy.
          </p>
        </div>
      `;
      return;
    ...
    container.innerHTML = `
      <div style="display: flex; flex-direction: column; gap: var(--spacing-2);">
        ${recent.map(a => `
          <div class="feature-card" style="padding: var(--spacing-3); margin-bottom: 0; border-left: 3px solid #2E7D32; display: flex; justify-content: space-between; align-items: center;">
            <div>
              <div style="display: flex; align-items: center; gap: var(--spacing-2); margin-bottom: 2px;">
                <h5 style="font-size: var(--font-size-xs); font-weight: var(--font-weight-bold); margin: 0; color: var(--color-text-primary);">
                  ${a.testTitle || "Academic Test"}
                </h5>
                <span class="academic-badge" style="background: rgba(46, 125, 50, 0.12); color: #2E7D32; font-size: 0.65rem;">
                  ${a.percentage || 0}% Score
                </span>
              </div>
              <span style="font-size: 0.688rem; color: var(--color-text-secondary);">
                Score: ${a.score || 0}/${a.totalQuestions || 0} • ${new Date(a.timestamp).toLocaleDateString(undefined, { month: "short", day: "numeric" })}
              </span>
            </div>
            <button type="button" class="btn btn-outline btn-sm btn-review-attempt" data-attempt-id="${a.id}" style="padding: 4px 10px; font-size: 0.688rem;">
              Review
            </button>
          </div>
        `).join("")}
    ...
    container.querySelectorAll(".btn-review-attempt").forEach(btn => {
      btn.addEventListener("click", () => {
        const attemptId = btn.getAttribute("data-attempt-id");
        const found = attempts.find(x => x.id === attemptId);
        if (found) {
          this.renderTestResult(found);
        }
      });
    });
  }
  ...
  /**
   * Render Featured Practice Tests in Test Home
   */
  async renderHomeFeaturedTests(classId) {
    const chipsContainer = document.getElementById("test-home-filter-chips");
    const listContainer = document.getElementById("test-home-tests-list");
    if (!chipsContainer || !listContainer) return;

    const subjects = await window.NotesWallahDatabase.getSubjects(classId);
    ...
    chipsContainer.innerHTML = `
      ...
      ${subjects.map(s => `
        <button type="button" class="choice-chip ${this.currentFilterSubject === s.id ? 'selected' : ''}" data-filter-subject="${s.id}">
          ${s.name}
        </button>
      `).join("")}
    `;

    chipsContainer.querySelectorAll("[data-filter-subject]").forEach(chip => {
      chip.addEventListener("click", () => {
        this.currentFilterSubject = chip.getAttribute("data-filter-subject");
        this.renderHomeFeaturedTests(classId);
      });
    });

    const tests = this.getTestsForClass(classId, this.currentFilterSubject);

    if (tests.length === 0) {
      listContainer.innerHTML = `
        <div class="empty-state" style="margin-top: var(--spacing-2);">
          ...
          <p class="empty-state-subtitle">No test series match the selected filter.</p>
        </div>
      `;
      return;
    }
    ...
    listContainer.innerHTML = tests.map(test => `
      <div class="feature-card test-item-card" data-test-id="${test.id}" style="cursor: pointer; border-left: 4px solid var(--brand-gold); margin-bottom: 0;">
        <div class="card-header-row" style="margin-bottom: var(--spacing-1);">
          <div style="display: flex; gap: var(--spacing-2); align-items: center;">
            <span class="card-tag" style="color: var(--brand-navy-primary);">${test.subject_name || "Academic"}</span>
            <span class="academic-badge" style="font-size: 0.65rem;">${test.difficulty || "Standard"}</span>
          </div>
          <span style="font-size: var(--font-size-xs); color: var(--color-text-secondary);">⏱️ ${test.duration_mins || 15} Mins</span>
        </div>
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; border-top: 1px solid var(--color-border-subtle); padding-top: var(--spacing-2);">
          <span style="font-size: var(--font-size-xs); color: var(--color-text-secondary); font-weight: var(--font-weight-semibold);">
            📝 ${test.questions ? test.questions.length : (test.question_count || 10)} Questions
          </span>
    ...
    listContainer.querySelectorAll(".btn-launch-test, .test-item-card").forEach(el => {
      el.addEventListener("click", (e) => {
        e.stopPropagation();
        const testId = el.getAttribute("data-test-id");
        if (testId) this.openTestConfigModal(testId);
      });
    });
  }

  /**
   * 1. Full Syllabus Mocks View
   */
  openFullSyllabus(classId) {
    this.showSubview("full-syllabus", true);
    const container = document.getElementById("test-full-syllabus-list");
    if (!container) return;

    const normClass = window.NotesWallahDatabase.normalizeClassId(classId);
    const fullTests = this.tests.filter(t => t.class_id === normClass && (t.test_type === "full_syllabus" || t.id.includes("full")));
    ...
    if (fullTests.length === 0) {
      container.innerHTML = `
        <div class="empty-state">
          ...
          <h4 class="empty-state-title">No Full Syllabus Tests Available</h4>
          <p class="empty-state-subtitle">Full-length board examination mocks will be scheduled prior to final exams.</p>
        </div>
      `;
      return;
    }

    container.innerHTML = fullTests.map(test => `
      <div class="feature-card" style="border-left: 4px solid var(--brand-navy-primary); margin-bottom: 0;">
        <div class="card-header-row" style="margin-bottom: var(--spacing-1);">
          <span class="card-tag" style="color: var(--brand-navy-primary);">${test.subject_name || "Full Syllabus"}</span>
          <span class="academic-badge status-connected" style="font-size: 0.65rem;">${test.difficulty || "Board Exam"}</span>
        </div>
        <h4 class="card-title" style="font-size: var(--font-size-sm); margin-bottom: 4px;">${test.title}</h4>
        <p class="card-desc" style="font-size: var(--font-size-xs); margin-bottom: var(--spacing-3);">${test.description}</p>
        
        <div style="background: var(--color-bg-subtle); padding: var(--spacing-2) var(--spacing-3); border-radius: var(--radius-sm); margin-bottom: var(--spacing-3); font-size: 0.688rem; display: flex; justify-content: space-between;">
          <span>📚 <strong>Curriculum:</strong> CBSE Official Blueprint</span>
          <span>⏱️ <strong>Time:</strong> ${test.duration_mins || 15} Mins</span>
        </div>
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; border-top: 1px solid var(--color-border-subtle); padding-top: var(--spacing-2);">
          ...
          <button type="button" class="btn btn-primary btn-sm btn-start-full-test" data-test-id="${test.id}">
    ...
    container.querySelectorAll(".btn-start-full-test").forEach(btn => {
      btn.addEventListener("click", () => {
   ...
   */
  async openSubjectTests(classId) {
    this.showSubview("subjects", true);
    const grid = document.getElementById("test-subjects-grid");
    if (!grid) return;

    const normClass = window.NotesWallahDatabase.normalizeClassId(classId);
    const subjects = await window.NotesWallahDatabase.getSubjects(normClass);

    if (subjects.length === 0) {
      grid.innerHTML = `
        <div class="empty-state" style="grid-column: 1 / -1;">
          <h4 class="empty-state-title">No Subjects Found</h4>
          <p class="empty-state-subtitle">No subjects registered for this class.</p>
        </div>
      `;
      return;
    }
    ...
    grid.innerHTML = subjects.map(s => {
      const subjectTests = this.tests.filter(t => t.class_id === normClass && t.subject_id === s.id);
      return `
        <div class="subject-card test-subject-select-card" data-subject-id="${s.id}" style="cursor: pointer;">
          <div class="subject-icon-box">
            <svg class="icon-svg" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1 4-10z"/></svg>
          </div>
          <div class="subject-card-body">
            <h4 class="subject-title">${s.name}</h4>
            <p class="subject-meta">${subjectTests.length} Tests Available</p>
          </div>
          <div class="subject-arrow-wrap">
            <svg class="icon-svg icon-svg-sm" viewBox="0 0 24 24"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
          </div>
        </div>
      `;
    }).join("");

    grid.querySelectorAll(".test-subject-select-card").forEach(card => {
      card.addEventListener("click", () => {
        const sId = card.getAttribute("data-subject-id");
        const subj = subjects.find(x => x.id === sId);
        if (subj) this.openChaptersForSubject(normClass, subj);
      });
    });
  }

  /**
   * 3. Chapter Selection View
   */
  async openChaptersForSubject(classId, subject) {
    this.showSubview("chapters", true);
    this.selectedSubject = subject;

    const titleEl = document.getElementById("test-chapters-subject-title");
    if (titleEl) titleEl.textContent = subject.name;

    const listContainer = document.getElementById("test-chapters-list");
    if (!listContainer) return;

    const chapters = await window.NotesWallahDatabase.getChapters(subject.id);

    if (chapters.length === 0) {
      listContainer.innerHTML = `
        <div class="empty-state">
          <h4 class="empty-state-title">No Chapters Found</h4>
          <p class="empty-state-subtitle">Chapters for ${subject.name} have not been published yet.</p>
        </div>
      `;
      return;
    }
    ...
    listContainer.innerHTML = chapters.map(ch => {
      const hasTest = this.tests.some(t => t.chapter_id === ch.id || (t.subject_id === subject.id && t.chapter_id === ch.id));
      return `
        <div class="chapter-item-card test-chapter-select-card" data-chapter-id="${ch.id}" style="cursor: pointer;">
          <div class="chapter-num-pill">${ch.chapter_number || 1}</div>
          <div class="chapter-card-body">
            <h4 class="chapter-card-title">${ch.name}</h4>
            <div class="chapter-badge-row">
              <span class="academic-badge ${hasTest ? 'status-connected' : 'status-pending'}" style="font-size: 0.65rem;">
                ${hasTest ? 'Test Available' : 'No test yet'}
              </span>
            </div>
          </div>
    ...
    listContainer.querySelectorAll(".test-chapter-select-card").forEach(card => {
      card.addEventListener("click", () => {
        const cId = card.getAttribute("data-chapter-id");
        const chap = chapters.find(x => x.id === cId);
        if (chap) this.openChapterDetail(classId, subject, chap);
      });
    });
  }

  /**
   * 4. Chapter Test Detail View
   */
  openChapterDetail(classId, subject, chapter) {
    this.showSubview("chapter-detail", true);
    this.selectedChapter = chapter;

    const numEl = document.getElementById("test-detail-chapter-num");
    const titleEl = document.getElementById("test-detail-chapter-title");
    const metaEl = document.getElementById("test-detail-meta");

    if (numEl) numEl.textContent = `Chapter ${chapter.chapter_number || 1}`;
    if (titleEl) titleEl.textContent = chapter.name;
    if (metaEl) metaEl.textContent = `${window.NotesWallahDatabase.formatClassName(classId)} • ${subject.name} • Diagnostic Assessment`;

    const contentArea = document.getElementById("test-chapter-detail-content");
    if (!contentArea) return;

    // Look for matching test
    const test = this.tests.find(t => t.chapter_id === chapter.id) ||
                 this.tests.find(t => t.subject_id === subject.id && t.chapter_id === chapter.id) ||
                 this.tests.find(t => t.subject_id === subject.id && t.test_type === "chapter");
    ...
    if (!test) {
      contentArea.innerHTML = `
        <div class="empty-state" style="padding: var(--spacing-4);">
          ...
          <h4 class="empty-state-title">No test available for this chapter yet.</h4>
          <p class="empty-state-subtitle">
            Diagnostic questions and NCERT quizzes for "${chapter.name}" will be introduced shortly.
          </p>
          <button type="button" class="btn btn-outline btn-sm" id="btn-return-to-chapters" style="margin-top: var(--spacing-3);">
            ← Choose Another Chapter
          </button>
        </div>
      `;
      const retBtn = document.getElementById("btn-return-to-chapters");
      if (retBtn) retBtn.onclick = () => this.goBack(classId);
      return;
    }

    contentArea.innerHTML = `
      <div class="feature-card" style="border-left: 4px solid var(--brand-gold); margin-bottom: var(--spacing-4);">
        <div class="card-header-row" style="margin-bottom: var(--spacing-2);">
          <span class="card-tag" style="color: var(--brand-navy-primary);">${subject.name} Diagnostic</span>
          <span class="academic-badge status-connected">${test.difficulty || "Standard"}</span>
        </div>
        <h4 class="card-title" style="font-size: var(--font-size-base); margin-bottom: var(--spacing-1);">${test.title}</h4>
        <p class="card-desc" style="font-size: var(--font-size-xs); margin-bottom: var(--spacing-4);">${test.description}</p>

        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: var(--spacing-2); text-align: center; margin-bottom: var(--spacing-4);">
          <div style="background: var(--color-bg-subtle); padding: var(--spacing-2); border-radius: var(--radius-sm);">
            <strong style="color: var(--brand-navy-primary); display: block; font-size: var(--font-size-sm);">${test.questions ? test.questions.length : (test.question_count || 5)}</strong>
            <span style="font-size: 0.625rem; color: var(--color-text-secondary);">Questions</span>
          </div>
          <div style="background: var(--color-bg-subtle); padding: var(--spacing-2); border-radius: var(--radius-sm);">
            <strong style="color: var(--brand-gold); display: block; font-size: var(--font-size-sm);">${test.duration_mins || 15} Mins</strong>
            <span style="font-size: 0.625rem; color: var(--color-text-secondary);">Duration</span>
          </div>
          <div style="background: var(--color-bg-subtle); padding: var(--spacing-2); border-radius: var(--radius-sm);">
            <strong style="color: #2E7D32; display: block; font-size: var(--font-size-sm);">NCERT</strong>
            <span style="font-size: 0.625rem; color: var(--color-text-secondary);">Pattern</span>
          </div>
        </div>

        <button type="button" class="btn btn-primary btn-block btn-launch-chapter-test" data-test-id="${test.id}">
          Configure & Start Test →
        </button>
      </div>
    `;

    const launchBtn = contentArea.querySelector(".btn-launch-chapter-test");
    if (launchBtn) {
      launchBtn.onclick = () => {
        this.openTestConfigModal(test.id);
      };
    }
  }
  ...
  async openTestHistory() {
    this.showSubview("history", true);
    const listContainer = document.getElementById("test-history-full-list");
    if (!listContainer) return;
    ...
    if (!attempts || attempts.length === 0) {
      listContainer.innerHTML = `
        <div class="empty-state">
          ...
          <h4 class="empty-state-title">No tests completed yet.</h4>
          <p class="empty-state-subtitle">
            Take any full syllabus mock, subject quiz, or chapter test to track your academic records.
          </p>
        </div>
      `;
      return;
    ...
    listContainer.innerHTML = attempts.map(a => `
      <div class="feature-card" style="border-left: 4px solid #2E7D32; margin-bottom: 0;">
        <div class="card-header-row" style="margin-bottom: var(--spacing-1);">
          <span class="card-tag" style="color: var(--brand-navy-primary);">${a.subjectName || "Academic Test"}</span>
          <span class="academic-badge ${a.percentage >= 70 ? 'status-connected' : 'status-pending'}">
            ${a.percentage}% Score
          </span>
        </div>
        <h4 class="card-title" style="font-size: var(--font-size-sm); margin-bottom: 2px;">${a.testTitle}</h4>
        <p class="card-desc" style="font-size: var(--font-size-xs); color: var(--color-text-secondary); margin-bottom: var(--spacing-3);">
          Taken on ${new Date(a.timestamp).toLocaleDateString(undefined, { dateStyle: "medium" })} at ${new Date(a.timestamp).toLocaleTimeString(undefined, { timeStyle: "short" })}
        </p>

        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: var(--spacing-2); text-align: center; margin-bottom: var(--spacing-3); background: var(--color-bg-subtle); padding: var(--spacing-2); border-radius: var(--radius-sm);">
          <div>
            <strong style="color: #2E7D32; display: block; font-size: var(--font-size-xs);">${a.correctCount}/${a.totalQuestions}</strong>
            <span style="font-size: 0.625rem; color: var(--color-text-secondary);">Correct</span>
          </div>
          <div>
            <strong style="color: var(--brand-gold); display: block; font-size: var(--font-size-xs);">${a.accuracy}%</strong>
            <span style="font-size: 0.625rem; color: var(--color-text-secondary);">Accuracy</span>
          </div>
          <div>
            <strong style="color: var(--color-text-primary); display: block; font-size: var(--font-size-xs);">${Math.floor((a.timeSpentSeconds || 0) / 60)}m ${(a.timeSpentSeconds || 0) % 60}s</strong>
            <span style="font-size: 0.625rem; color: var(--color-text-secondary);">Time</span>
          </div>
        </div>

        <button type="button" class="btn btn-outline btn-block btn-sm btn-view-full-review" data-attempt-id="${a.id}">
          Review Question Solutions →
        </button>
      </div>
    `).join("");

    listContainer.querySelectorAll(".btn-view-full-review").forEach(btn => {
      btn.addEventListener("click", () => {
        const attemptId = btn.getAttribute("data-attempt-id");
        const found = attempts.find(x => x.id === attemptId);
        if (found) this.renderTestResult(found);
      });
    });
  }
  ...
  openTestConfigModal(testId) {
    ...
    if (modalQCount) modalQCount.textContent = `${test.questions ? test.questions.length : (test.question_count || 10)} Questions`;
    if (modalDuration) modalDuration.textContent = `${test.duration_mins || 15} Minutes`;
   ...
   */
  async startTest(testId, config = { timed: true }) {
    let test = this.getTestById(testId);
    if (!test) {
      try {
        const stored = JSON.parse(localStorage.getItem("nw_custom_tests") || "[]");
        test = stored.find(t => t.id === testId);
      } catch (e) {}
    }
    if (!test) return;

    // Load questions if not in seed
    if (!test.questions || test.questions.length === 0) {
      try {
        const qList = await window.NotesWallahDatabase.getTestQuestions(testId);
        if (qList && qList.length > 0) {
          test.questions = qList;
        }
      } catch (e) {
        console.warn("[TestEngine] Could not load questions:", e);
      }
    }

    if (!test.questions || test.questions.length === 0) {
      window.NotesWallahUI.showToast("No questions available for this test yet.", "info");
      return;
    }
    ...
    this.activeSession = {
      ...
      remainingSeconds: config.timed ? (test.duration_mins || 15) * 60 : 0,
      elapsedSeconds: 0,
      startTime: Date.now()
    };
